...
/**
 * Shared settings page for user, counselor, and admin.
 * Only the labels change by role — the forms stay the same.
 */
function SettingsPage({ role = "user" }) {
  ...
  const labels = {
    user: {
      ...
      infoSubtitle: "Update your account details",
    },
    counselor: {
      pageSubtitle: "Manage your counselor account and preferences.",
      infoTitle: "Account Information",
      infoSubtitle: "Your counselor account details",
    },
    admin: {
      pageSubtitle: "Manage your admin account and preferences.",
      infoTitle: "Account Information",
      infoSubtitle: "Your admin account details",
    },
  }[role] || {
    pageSubtitle: "Manage your account and preferences.",
    infoTitle: "Account Information",
  ...
  return (
    <div>
      ...
      <p className="dashboard-page-subtitle">{labels.pageSubtitle}</p>

      <div style={{ display: "flex", flexDirection: "column", gap: "20px" }}>
        <div className="dashboard-grid dashboard-cards-2">
          <div className="dashboard-card">
            <SectionHeader icon={LuUser} title={labels.infoTitle} subtitle={labels.infoSubtitle} />
                ...
                <div style={{ display: "flex", alignItems: "center", gap: "10px" }}>
                  ...
                  <div style={{ textAlign: "left" }}>
                    ...
                    <p style={{ margin: 0, fontSize: "11px", color: "var(--text-muted)" }}>
                      {t === "light" ? "Bright and soft" : "Default theme"}
                    </p>
                  </div>
                </div>

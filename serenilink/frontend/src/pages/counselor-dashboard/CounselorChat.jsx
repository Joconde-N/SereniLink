    ...
    <div>
      ...
      <div className="dashboard-card">
        {loading ? (
          ...
          <div className="message-list" style={{ maxHeight: "500px", overflowY: "auto", paddingRight: "4px" }}>
            {messages.length === 0 ? (
              <div className="empty-state">No messages yet. Start the conversation with your client.</div>
            ) : (
              messages.map((msg) => {
